...
export const CalendarContextProvider = ({ children }: PropsWithChildren) => {
    ...
    // React-Aria version drift: the context's onChange accepts a wider (range) value type.
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    const contextValue = { value, onChange: onChange as any, focusedValue, onFocusChange };
